...
export default class TelegramClient {
    static connect(accessTokenOrConfig: string | Types.ClientConfig): TelegramClient;
    _token: string;
     ...
     */
    setWebhook(url: string, options?: Types.SetWebhookOption): Promise<boolean>;
    /**
     ...
     */
    sendMessage(chatId: string | number, text: string, options?: Types.SendMessageOption): Promise<Types.Message>;
    /**
     ...
     */
    forwardMessage(chatId: string | number, fromChatId: string | number, messageId: number, options?: Types.ForwardMessageOption): Promise<Types.Message>;
    /**
     ...
     */
    sendPhoto(chatId: string | number, photo: string, options?: Types.SendPhotoOption): Promise<Types.Message>;
    /**
     ...
     */
    sendAudio(chatId: string | number, audio: string, options?: Types.SendAudioOption): Promise<Types.Message>;
    /**
     ...
     */
    sendDocument(chatId: string | number, document: string, options?: Types.SendDocumentOption): Promise<Types.Message>;
    /**
     ...
     */
    sendVideo(chatId: string | number, video: string, options?: Types.SendVideoOption): Promise<Types.Message>;
    /**
     ...
     */
    sendAnimation(chatId: string | number, animation: string, options?: Types.SendAnimationOption): Promise<Types.Message>;
    /**
     ...
     */
    sendVoice(chatId: string | number, voice: string, options?: Types.SendVoiceOption): Promise<Types.Message>;
    /**
     ...
     */
    sendVideoNote(chatId: string | number, videoNote: string, options?: Types.SendVideoNoteOption): Promise<Types.Message>;
    /**
     ...
     */
    sendMediaGroup(chatId: string | number, media: (Types.InputMediaPhoto | Types.InputMediaVideo)[], options?: Types.SendMediaGroupOption): Promise<Types.Message[]>;
    /**
     ...
     */
    sendLocation(chatId: string | number, { latitude, longitude }: {
        latitude: number;
        longitude: number;
    }, options?: Types.SendLocationOption): Promise<Types.Message>;
    /**
    ...
    editMessageLiveLocation({ latitude, longitude }: {
        latitude: number;
        longitude: number;
    }, options: Types.EditMessageLiveLocationOption): Promise<Types.Message | boolean>;
    /**
     ...
     */
    stopMessageLiveLocation(options: Types.StopMessageLiveLocationOption): Promise<Types.Message | boolean>;
    /**
     ...
     */
    sendVenue(chatId: string | number, venue: Types.Venue, options?: Types.SendVenueOption): Promise<Types.Message>;
    /**
     ...
     */
    sendContact(chatId: string | number, requiredOptions: Types.SendContactRequiredOption, options?: Types.SendContactOption): Promise<Types.Message>;
    /**
     ...
     */
    sendPoll(chatId: string | number, question: string, options: string[], otherOptions?: Types.SendPollOption): Promise<Types.Message>;
    /**
     ...
     */
    sendChatAction(chatId: string | number, action: Types.ChatAction): Promise<boolean>;
    /**
     ...
     */
    getUserProfilePhotos(userId: number, options?: Types.GetUserProfilePhotosOption): Promise<Types.UserProfilePhotos>;
    /**
     ...
     */
    kickChatMember(chatId: string | number, userId: number, options?: Types.KickChatMemberOption): Promise<boolean>;
    /**
     ...
     */
    restrictChatMember(chatId: string | number, userId: number, permissions: Types.ChatPermissions, options?: Types.RestrictChatMemberOption): Promise<boolean>;
    /**
     ...
     */
    promoteChatMember(chatId: string | number, userId: number, options?: Types.PromoteChatMemberOption): Promise<boolean>;
    /**
     ...
     */
    setChatPermissions(chatId: string | number, permissions: Types.ChatPermissions): Promise<boolean>;
    /**
     ...
     */
    pinChatMessage(chatId: string | number, messageId: number, options?: Types.PinChatMessageOption): Promise<boolean>;
    /**
     ...
     */
    getChatMember(chatId: string | number, userId: number): Promise<Types.ChatMember>;
    /**
     ...
     */
    answerCallbackQuery(callbackQueryId: string, options: Types.AnswerCallbackQueryOption): Promise<boolean>;
    /**
     ...
     */
    editMessageText(text: string, options?: Types.EditMessageTextOption): Promise<Types.Message | boolean>;
    /**
     ...
     */
    editMessageCaption(caption: string, options?: Types.EditMessageCaptionOption): Promise<Types.Message | boolean>;
    /**
     ...
     */
    editMessageMedia(media: Types.InputMedia, options: Types.EditMessageMediaOption): Promise<Types.Message | boolean>;
    /**
     ...
     */
    editMessageReplyMarkup(replyMarkup: Types.InlineKeyboardMarkup, options?: Types.EditMessageReplyMarkupOption): Promise<Types.Message | boolean>;
    /**
     ...
     */
    stopPoll(chatId: string | number, messageId: number, options?: Types.StopPollOption): Promise<Types.Poll>;
    /**
     ...
     */
    sendSticker(chatId: string | number, sticker: string, options?: Types.SendStickerOption): Promise<Types.Message>;
    /**
     ...
     */
    createNewStickerSet(userId: number, name: string, title: string, pngSticker: string, emojis: string, options?: Types.CreateNewStickerSetOption): Promise<boolean>;
    /**
     ...
     */
    addStickerToSet(userId: number, name: string, pngSticker: string, emojis: string, options?: Types.AddStickerToSetOption): Promise<boolean>;
    /**
     ...
     */
    answerInlineQuery(inlineQueryId: string, results: Types.InlineQueryResult[], options?: Types.AnswerInlineQueryOption): Promise<boolean>;
    /**
     ...
     */
    sendInvoice(chatId: number, product: Types.Product, options?: Types.SendInvoiceOption): Promise<Types.Message>;
    /**
     ...
     */
    answerShippingQuery(shippingQueryId: string, ok: boolean, options?: Types.AnswerShippingQueryOption): Promise<boolean>;
    /**
     ...
     */
    answerPreCheckoutQuery(preCheckoutQueryId: string, ok: boolean, options?: Types.AnswerPreCheckoutQueryOption): Promise<boolean>;
    /**
     ...
     */
    sendGame(chatId: number, gameShortName: string, options?: Types.SendGameOption): Promise<Types.Message>;
    /**
     ...
     */
    setGameScore(userId: number, score: number, options?: Types.SetGameScoreOption): Promise<Types.Message | boolean>;
    /**
     ...
     */
    getGameHighScores(userId: number, options?: Types.GetGameHighScoresOption): Promise<Types.GameHighScore[]>;
}

...
export declare type SendVideoNoteOption = {
    /**
     * Duration of sent video in seconds
     */
    duration?: number;
...
export declare type SendMediaGroupOption = {
    /**
     * Sends the message silently. Users will receive a notification with no sound.
     *
     * - https://telegram.org/blog/channels-2-0#silent-messages
...
export declare type SendLocationOption = {
    /**
...
export declare type EditOption = {
    /**
...
export declare type EditMessageLiveLocationOption = EditOption & {
    /**
...
export declare type StopMessageLiveLocationOption = EditOption & {
    /**
     * A JSON-serialized object for a new inline keyboard.
     *
     * - https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating
...
export declare type SendVenueOption = {
    /**
...
export declare type SendContactRequiredOption = {
    /**
...
export declare type SendContactOption = {
    /**
     * Contact's last name
     */
    lastName?: string;
...
export declare type SendPollOption = {
    /**
     * Sends the message silently. Users will receive a notification with no sound.
     *
     * - https://telegram.org/blog/channels-2-0#silent-messages
...
export declare type GetUserProfilePhotosOption = {
    /**
...
export declare type KickChatMemberOption = {
    /**
     * Date when the user will be unbanned, unix time. If user is banned for more than 366 days or less than 30 seconds from the current time they are considered to be banned forever
     */
    untilDate?: number;
};
export declare type RestrictChatMemberOption = {
    /**
     * Date when restrictions will be lifted for the user, unix time. If user is restricted for more than 366 days or less than 30 seconds from the current time, they are considered to be restricted forever
     */
    untilDate?: number;
};
export declare type PromoteChatMemberOption = {
    /**
...
export declare type PinChatMessageOption = {
    /**
     * Pass True, if it is not necessary to send a notification to all chat members about the new pinned message. Notifications are always disabled in channels.
     */
    disableNotification?: boolean;
};
export declare type EditMessageTextOption = EditOption & {
    /**
     * Send Markdown or HTML, if you want Telegram apps to show bold, italic, fixed-width text or inline URLs in your bot's message.
     *
     * - https://core.telegram.org/bots/api#markdown-style
...
export declare type EditMessageCaptionOption = EditOption & {
    /**
     * Send Markdown or HTML, if you want Telegram apps to show bold, italic, fixed-width text or inline URLs in your bot's message.
     *
     * - https://core.telegram.org/bots/api#markdown-style
...
export declare type EditMessageMediaOption = EditOption & {
    /**
     * A JSON-serialized object for an inline keyboard.
     *
     * - https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating
...
export declare type EditMessageReplyMarkupOption = EditOption;
export declare type StopPollOption = {
    /**
     * A JSON-serialized object for an inline keyboard.
     *
     * - https://core.telegram.org/bots#inline-keyboards-and-on-the-fly-updating
...
export declare type SendStickerOption = {
    /**
     * Sends the message silently. Users will receive a notification with no sound.
     *
     * - https://telegram.org/blog/channels-2-0#silent-messages
...
export declare type AnswerInlineQueryOption = {
    /**
...
export declare type SendInvoiceOption = {
    /**
...
export declare type AnswerShippingQueryOption = {
    /**
...
export declare type AnswerPreCheckoutQueryOption = {
    /**
     * Required if ok is False. Error message in human readable form that explains the reason for failure to proceed with the checkout (e.g. "Sorry, somebody just bought the last of our amazing black T-shirts while you were busy filling out your payment details. Please choose a different color or garment!"). Telegram will display this message to the user.
     */
    errorMessage?: string;
};
export declare type AnswerCallbackQueryOption = {
    /**
...
export declare type SendGameOption = {
    /**
     * Sends the message silently. Users will receive a notification with no sound.
     *
     * - https://telegram.org/blog/channels-2-0#silent-messages
...
export declare type SetGameScoreOption = EditOption & {
    /**
...
export declare type GetGameHighScoresOption = EditOption;
export declare type CreateNewStickerSetOption = {
    /**
...
export declare type AddStickerToSetOption = {
    /**
     * A JSON-serialized object for position where the mask should be placed on faces
     */
    maskPosition?: MaskPosition;

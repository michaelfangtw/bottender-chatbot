...
class TelegramClient {
    ...
    _request(path, body = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this._axios.post(path, messaging_api_common_1.snakecaseKeysDeep(body));
                ...
                if (isPlainObject_1.default(data.result) || Array.isArray(data.result)) {
                    return messaging_api_common_1.camelcaseKeysDeep(data.result);
                }
                return data.result;
            }
            catch (err) {
     ...
     */
    getUpdates(options) {
        return this._request('/getUpdates', Object.assign({}, options));
    }
    /**
    ...
    setWebhook(url, options = {}) {
        ...
        return this._request('/setWebhook', Object.assign({ url }, optionsWithoutCertificate));
    }
    /**
    ...
    sendMessage(chatId, text, options) {
        return this._request('/sendMessage', Object.assign({ chatId,
            text }, options));
    }
    /**
    ...
    forwardMessage(chatId, fromChatId, messageId, options) {
        return this._request('/forwardMessage', Object.assign({ chatId,
            fromChatId,
            messageId }, options));
    }
    /**
    ...
    sendPhoto(chatId, photo, options = {}) {
        return this._request('/sendPhoto', Object.assign({ chatId,
            photo }, options));
    }
    /**
    ...
    sendAudio(chatId, audio, options = {}) {
        const optionsWithoutThumb = pick_1.default(options, [
            'caption',
            'parse_mode',
            'parseMode',
            'duration',
        ...
        return this._request('/sendAudio', Object.assign({ chatId,
    ...
    sendDocument(chatId, document, options = {}) {
        ...
        return this._request('/sendDocument', Object.assign({ chat_id: chatId, document }, optionsWithoutThumb));
    }
    /**
    ...
    sendVideo(chatId, video, options = {}) {
        const optionsWithoutThumb = this._optionWithoutKeys(options, ['thumb']);
        return this._request('/sendVideo', Object.assign({ chatId,
    ...
    sendAnimation(chatId, animation, options = {}) {
        const optionsWithoutThumb = this._optionWithoutKeys(options, ['thumb']);
        return this._request('/sendAnimation', Object.assign({ chatId,
    ...
    sendVoice(chatId, voice, options = {}) {
        return this._request('/sendVoice', Object.assign({ chatId,
            voice }, options));
    }
    /**
    ...
    sendVideoNote(chatId, videoNote, options = {}) {
        const optionsWithoutThumb = this._optionWithoutKeys(options, ['thumb']);
        return this._request('/sendVideoNote', Object.assign({ chatId,
    ...
    sendMediaGroup(chatId, media, options) {
        const mediaWithoutThumb = media.map(m => this._optionWithoutKeys(m, ['thumb']));
        return this._request('/sendMediaGroup', Object.assign({ chatId, media: mediaWithoutThumb }, options));
    }
    /**
    ...
    sendLocation(chatId, { latitude, longitude }, options) {
        return this._request('/sendLocation', Object.assign({ chatId,
            latitude,
            longitude }, options));
    }
    /**
    ...
    editMessageLiveLocation({ latitude, longitude }, options) {
        return this._request('/editMessageLiveLocation', Object.assign({ latitude,
            longitude }, options));
    }
    /**
    ...
    stopMessageLiveLocation(options) {
        return this._request('/stopMessageLiveLocation', Object.assign({}, options));
    }
    /**
    ...
    sendVenue(chatId, venue, options) {
        return this._request('/sendVenue', Object.assign(Object.assign(Object.assign({ chatId }, venue.location), this._optionWithoutKeys(venue, ['location'])), options));
    }
    /**
     ...
     */
    sendContact(chatId, requiredOptions, options) {
        return this._request('/sendContact', Object.assign(Object.assign({ chatId }, requiredOptions), options));
    }
    /**
    ...
    sendPoll(chatId, question, options, otherOptions) {
        return this._request('/sendPoll', Object.assign({ chatId,
            question,
    ...
    getUserProfilePhotos(userId, options) {
        return this._request('/getUserProfilePhotos', Object.assign({ userId }, options));
    }
    /**
     ...
     */
    getFileLink(fileId) {
        return this.getFile(fileId).then(result => `https://api.telegram.org/file/bot${this._token}/${result.filePath}`);
    }
    /**
    ...
    kickChatMember(chatId, userId, options) {
        return this._request('/kickChatMember', Object.assign({ chatId,
            userId }, options));
    }
    /**
    ...
    restrictChatMember(chatId, userId, permissions, options) {
        return this._request('/restrictChatMember', Object.assign({ chatId,
            userId,
            permissions }, options));
    }
    /**
    ...
    promoteChatMember(chatId, userId, options) {
        return this._request('/promoteChatMember', Object.assign({ chatId,
            userId }, options));
    }
    /**
    ...
    pinChatMessage(chatId, messageId, options) {
        return this._request('/pinChatMessage', Object.assign({ chatId,
            messageId }, options));
    }
    /**
    ...
    answerCallbackQuery(callbackQueryId, options) {
        return this._request('/answerCallbackQuery', Object.assign({ callbackQueryId }, options));
    }
    /**
    ...
    editMessageText(text, options) {
        return this._request('/editMessageText', Object.assign({ text }, options));
    }
    /**
    ...
    editMessageCaption(caption, options) {
        return this._request('/editMessageCaption', Object.assign({ caption }, options));
    }
    /**
    ...
    editMessageMedia(media, options) {
        return this._request('/editMessageMedia', Object.assign({ media }, options));
    }
    /**
    ...
    editMessageReplyMarkup(replyMarkup, options) {
        return this._request('/editMessageReplyMarkup', Object.assign({ replyMarkup }, options));
    }
    /**
    ...
    stopPoll(chatId, messageId, options) {
        return this._request('/stopPoll', Object.assign({ chatId,
            messageId }, options));
    }
    /**
    ...
    sendSticker(chatId, sticker, options) {
        return this._request('/sendSticker', Object.assign({ chatId,
            sticker }, options));
    }
    /**
    ...
    createNewStickerSet(userId, name, title, pngSticker, emojis, options) {
        return this._request('/createNewStickerSet', Object.assign({ userId,
            name,
            title,
            pngSticker,
            emojis }, options));
    ...
    addStickerToSet(userId, name, pngSticker, emojis, options) {
        return this._request('/addStickerToSet', Object.assign({ userId,
            name,
            pngSticker,
            emojis }, options));
    }
    ...
    answerInlineQuery(inlineQueryId, results, options) {
        return this._request('/answerInlineQuery', Object.assign({ inlineQueryId,
            results }, options));
    }
    /**
    ...
    sendInvoice(chatId, product, options) {
        return this._request('/sendInvoice', Object.assign(Object.assign({ chatId }, product), options));
    }
    /**
    ...
    answerShippingQuery(shippingQueryId, ok, options) {
        return this._request('/answerShippingQuery', Object.assign({ shippingQueryId,
            ok }, options));
    }
    /**
    ...
    answerPreCheckoutQuery(preCheckoutQueryId, ok, options) {
        return this._request('/answerPreCheckoutQuery', Object.assign({ preCheckoutQueryId,
            ok }, options));
    }
    /**
    ...
    sendGame(chatId, gameShortName, options) {
        return this._request('/sendGame', Object.assign({ chatId,
    ...
    setGameScore(userId, score, options) {
        return this._request('/setGameScore', Object.assign({ userId,
            score }, options));
    }
    /**
    ...
    getGameHighScores(userId, options) {
        return this._request('/getGameHighScores', Object.assign({ userId }, options));
    }
}

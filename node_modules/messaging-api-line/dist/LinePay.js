...
class LinePay {
    ...
    getPayments({ transactionId, orderId, } = {}) {
        invariant_1.default(transactionId || orderId, 'getPayments: One of `transactionId` or `orderId` must be provided');
        const query = {};
        if (transactionId) {
    ...
    getAuthorizations({ transactionId, orderId, } = {}) {
        invariant_1.default(transactionId || orderId, 'getAuthorizations: One of `transactionId` or `orderId` must be provided');
        const query = {};
        if (transactionId) {
            query.transactionId = transactionId;
        }

...
class ViberClient {
    ...
    static connect(accessTokenOrConfig, sender) {
    ...
    _callAPI(path, body = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this._axios.post(path, 
    ...
    sendMessage(receiver, message) {
        return this._callAPI('/send_message', Object.assign({ receiver, sender: this._sender }, transformMessageCase(message)));
    }
    /**
    ...
    broadcastMessage(broadcastList, message) {
        return this._callAPI('/broadcast_message', Object.assign({ broadcastList, sender: this._sender }, transformMessageCase(message)));
    }
    /**
     * https://developers.viber.com/docs/api/rest-bot-api/#text-message
     */

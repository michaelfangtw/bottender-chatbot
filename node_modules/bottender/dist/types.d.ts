...
export declare type Client = ConsoleClient | MessengerClient | LineClient | SlackOAuthClient | TelegramClient | ViberClient;
export declare type Event = ConsoleEvent | MessengerEvent | LineEvent | SlackEvent | TelegramEvent | ViberEvent;
export declare type Body = ConsoleRawEvent | MessengerRequestBody | LineRequestBody | SlackRequestBody | TelegramRequestBody | ViberRequestBody;
export declare type Action<C extends Client, E extends Event> = (context: Context<C, E>, props?: Props<C, E>) => void | Action<C, E> | Promise<Action<C, E> | void>;
export declare type Props<C extends Client, E extends Event> = {
    next?: Action<C, E>;
    error?: Error;
    [key: string]: any;
};
export declare type Plugin<C extends Client, E extends Event> = (context: Context<C, E>) => void;

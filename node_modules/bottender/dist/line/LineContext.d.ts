...
declare class LineContext extends Context<LineClient, LineEvent> {
    ...
    replyText(text: string, options?: LineTypes.MessageOptions): Promise<LineTypes.MutationSuccessResponse> | undefined;
    replyImage(image: {
    ...
    pushText(text: string, options?: LineTypes.MessageOptions): Promise<LineTypes.MutationSuccessResponse> | undefined;
    pushImage(image: {
        originalContentUrl: string;
        previewImageUrl?: string;
    }, options?: LineTypes.MessageOptions): Promise<LineTypes.MutationSuccessResponse> | undefined;
    ...
    sendText(text: string, options?: LineTypes.MessageOptions): Promise<LineTypes.MutationSuccessResponse> | undefined;
    sendImage(image: {
        originalContentUrl: string;
        previewImageUrl?: string;
    }, options?: LineTypes.MessageOptions): Promise<LineTypes.MutationSuccessResponse> | undefined;

...
const main = (argvFrom2) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error(log_1.error(`An unexpected error occurred in provider ${subcommand}: ${err.stack}`));
    }
});
const handleUnexpected = (err) => {
    console.error(log_1.error(`An unexpected error occurred!\n  ${err.stack} ${err.stack}`));
    process.exit(1);
};
const handleRejection = (reason) => {
    if (reason) {
        if (reason instanceof Error) {
            ...
            console.error(log_1.error(`An unexpected rejection occurred\n  ${reason}`));
        }
    }
    else {
        console.error(log_1.error('An unexpected empty rejection occurred'));
    }
    process.exit(1);
};
